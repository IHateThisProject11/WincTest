...
static void MX_FDCAN1_Init(void)
{
  ...
  hfdcan1.Init.Mode        = FDCAN_MODE_BUS_MONITORING;   // listen-only (no ACK)
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(CHIP_EN_WINC_GPIO_Port, CHIP_EN_WINC_Pin, GPIO_PIN_RESET); // keep WINC off
  ...
  /*Configure GPIO pins : RESET_WINC_Pin CHIP_EN_WINC_Pin SD_CS_Pin */
  GPIO_InitStruct.Pin = RESET_WINC_Pin|CHIP_EN_WINC_Pin|SD_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
